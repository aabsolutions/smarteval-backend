...
const create_bulk_students_dto_1 = require("./dto/create-bulk-students.dto");
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_bulk_students_dto_1.CreateBulkStudentsDto]),
    __metadata("design:returntype", void 0)
], StudentsController.prototype, "createBulk", null);
__decorate([
    (0, roles_decorator_1.Roles)('SUPERADMIN', 'ADMIN', 'TEACHER'),
    (0, common_1.Get)(),
    __metadata("design:type", Function),
